...
import pbclient
from pbclient.models.parcel_protection_policy_response import ParcelProtectionPolicyResponse  # noqa: E501
...
class TestParcelProtectionPolicyResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `ParcelProtectionPolicyResponse`
        """
        model = pbclient.models.parcel_protection_policy_response.ParcelProtectionPolicyResponse()  # noqa: E501
        if include_optional :
            return ParcelProtectionPolicyResponse(
                content = [
                    pbclient.models.parcel_protection_policy_response_content_inner.ParcelProtectionPolicyResponse_content_inner(
                        transaction_id = '', 
                        developer_id = '', 
                        subscription_acc_no = '', 
                ...
                sort = [
                    pbclient.models.parcel_protection_policy_response_sort_inner.ParcelProtectionPolicyResponse_sort_inner(
                        direction = '', 
                        property = '', 
                        ignore_case = True, 
                        null_handling = '', 
