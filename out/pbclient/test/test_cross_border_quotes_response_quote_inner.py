...
import pbclient
from pbclient.models.cross_border_quotes_response_quote_inner import CrossBorderQuotesResponseQuoteInner  # noqa: E501
from pbclient.rest import ApiException

class TestCrossBorderQuotesResponseQuoteInner(unittest.TestCase):
    """CrossBorderQuotesResponseQuoteInner unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test CrossBorderQuotesResponseQuoteInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CrossBorderQuotesResponseQuoteInner`
        """
        model = pbclient.models.cross_border_quotes_response_quote_inner.CrossBorderQuotesResponseQuoteInner()  # noqa: E501
        if include_optional :
            return CrossBorderQuotesResponseQuoteInner(
                quote_currency = '', 
                quote_lines = [
    ...
    def testCrossBorderQuotesResponseQuoteInner(self):
        """Test CrossBorderQuotesResponseQuoteInner"""
