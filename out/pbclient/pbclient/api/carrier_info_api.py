...
class CarrierInfoApi:
    ...
    def get_carrier_facilities(
        ...
        **kwargs,
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_carrier_facilities_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)

        return self.get_carrier_facilities_with_http_info.raw_function(
    ...
    def get_carrier_license_agreement(
        ...
        **kwargs,
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_carrier_license_agreement_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)

        return self.get_carrier_license_agreement_with_http_info.raw_function(
            carrier,
            origin_country_code,
            x_pb_unified_error_structure,
            **kwargs,
    ...
    def get_carrier_service_rules(
        ...
        **kwargs,
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_carrier_service_rules_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)

        return self.get_carrier_service_rules_with_http_info.raw_function(
            carrier,
            origin_country_code,
    ...
    def get_carrier_supported_destination(
        ...
        **kwargs,
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_carrier_supported_destination_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)

        return self.get_carrier_supported_destination_with_http_info.raw_function(
            carrier,
            origin_country_code,
            x_pb_unified_error_structure,
            **kwargs,
