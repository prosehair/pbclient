...
class CrossBorderQuotesApi:
    ...
    def get_cross_border_quotes(
        ...
        **kwargs,
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_cross_border_quotes_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)

        return self.get_cross_border_quotes_with_http_info.raw_function(
    ...
    def predicted_hs_code(
        ...
        **kwargs,
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the predicted_hs_code_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)

        return self.predicted_hs_code_with_http_info.raw_function(
            x_pb_transaction_id,
            manifest,
            x_pb_unified_error_structure,
            **kwargs,
