...
class ContainerApi:
    ...
    def get_containerized_parcels_labels(
        ...
        **kwargs,
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_containerized_parcels_labels_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)

        return self.get_containerized_parcels_labels_with_http_info.raw_function(
            x_pb_transaction_id,
            manifest,
    ...
    @validate_call
    def get_containerized_parcels_labels_with_http_info(
        self,
        x_pb_transaction_id: Annotated[StrictStr, Field(description="Required. A unique identifier for the transaction, up to 25 characters.")],
        manifest: Annotated[Manifest, Field(description="manifest")],
        x_pb_unified_error_structure: Annotated[Optional[StrictBool], Field(description="Set this to true to use the standard [error object](https://shipping.pitneybowes.com/reference/error-object.html#standard-error-object) if an error occurs.")] = None,
