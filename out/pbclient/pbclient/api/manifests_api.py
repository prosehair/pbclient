...
class ManifestsApi:
    ...
    def create_manifest(
        ...
        **kwargs,
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the create_manifest_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)

        return self.create_manifest_with_http_info.raw_function(
            x_pb_transaction_id,
            manifest,
    ...
    def reprint_manifest(
        ...
        **kwargs,
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the reprint_manifest_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)

        return self.reprint_manifest_with_http_info.raw_function(
            manifest_id,
            x_pb_unified_error_structure,
            **kwargs,
        )
    ...
    def reprint_manifest_with_http_info(
        ...
        **kwargs,
        ...
        # process the path parameters
        _path_params: Dict[str, str] = {}
        if _params['manifest_id'] is not None:
    ...
    def retry_manifest(
        ...
        **kwargs,
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the retry_manifest_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)

        return self.retry_manifest_with_http_info.raw_function(
