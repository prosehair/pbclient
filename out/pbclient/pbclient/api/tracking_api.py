...
class TrackingApi:
    ...
    def add_tracking_events(
        ...
        _param = self._add_tracking_events_serialize(
            add_tracking_events=add_tracking_events,
    ...
    def add_tracking_events_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AddTrackingEvents200Response]:
        """getTrackingDetails
    ...
    @validate_call
    def add_tracking_events_without_preload_content(
        self,
        add_tracking_events: Annotated[AddTrackingEvents, Field(description="add track event")],
        x_pb_unified_error_structure: Annotated[Optional[StrictBool], Field(description="Set this to true to use the standard [error object](https://shipping.pitneybowes.com/reference/error-object.html#standard-error-object) if an error occurs.")] = None,
        _request_timeout: Union[
    ...
    def _add_tracking_events_serialize(
        self,
        add_tracking_events,
        ...
        if add_tracking_events is not None:
            _body_params = add_tracking_events
    ...
    def get_tracking_details(
        ...
        _param = self._get_tracking_details_serialize(
            tracking_number=tracking_number,
            package_identifier_type=package_identifier_type,
            x_pb_unified_error_structure=x_pb_unified_error_structure,
            carrier=carrier,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_tracking_details_without_preload_content(
        self,
        tracking_number: Annotated[StrictStr, Field(description="The tracking number for the shipment.")],
        package_identifier_type: Annotated[StrictStr, Field(description="packageIdentifierType")],
        x_pb_unified_error_structure: Annotated[Optional[StrictBool], Field(description="Set this to true to use the standard [error object](https://shipping.pitneybowes.com/reference/error-object.html#standard-error-object) if an error occurs.")] = None,
    ...
    def _get_tracking_details_serialize(
        self,
        tracking_number,
        ...
        if tracking_number is not None:
            _path_params['trackingNumber'] = tracking_number
        # process the query parameters
        if package_identifier_type is not None:
            
            _query_params.append(('packageIdentifierType', package_identifier_type))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/shippingservices/v1/tracking/{trackingNumber}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
