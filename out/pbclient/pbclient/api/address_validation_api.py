...
class AddressValidationApi:
    ...
    def verify_address(
        ...
        **kwargs,
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the verify_address_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)

        return self.verify_address_with_http_info.raw_function(
            address,
    ...
    def verify_and_suggest_address(
        ...
        **kwargs,
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the verify_and_suggest_address_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)

        return self.verify_and_suggest_address_with_http_info.raw_function(
            return_suggestions,
