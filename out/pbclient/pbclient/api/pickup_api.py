...
class PickupApi:
    ...
    def cancel_pickup(
        ...
        **kwargs,
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the cancel_pickup_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)

        return self.cancel_pickup_with_http_info.raw_function(
            x_pb_transaction_id,
            pickup_id,
    ...
    def cancel_pickup_with_http_info(
        ...
        **kwargs,
        ...
        if _params['pickup_id'] is not None:
    ...
    def get_pickupschedule(
        ...
        **kwargs,
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_pickupschedule_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)

        return self.get_pickupschedule_with_http_info.raw_function(
            x_pb_transaction_id,
            schedule_pickup,
            x_pb_unified_error_structure,
            **kwargs,
