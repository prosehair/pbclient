...
from pbclient.api_response import ApiResponse, T as ApiResponseT
import pbclient.models
from pbclient import rest
from pbclient.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(pbclient.models, klass)
