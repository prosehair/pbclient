...
class ParcelProtectionCreateRequestShipmentInfoParcelInfo(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "commodityList": [ParcelProtectionCreateRequestShipmentInfoParcelInfoCommodityListInner.from_dict(_item) for _item in obj["commodityList"]] if obj.get("commodityList") is not None else None
        })
        return _obj
