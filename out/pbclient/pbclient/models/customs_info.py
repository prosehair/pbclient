...
class CustomsInfo(BaseModel):
    ...
    customs_declared_value: Optional[CustomsInfoCustomsDeclaredValue] = Field(default=None, alias="customsDeclaredValue")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "customsDeclaredValue": CustomsInfoCustomsDeclaredValue.from_dict(obj["customsDeclaredValue"]) if obj.get("customsDeclaredValue") is not None else None,
