...
class CrossBorderQuotesRequest(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "basketItems": [CrossBorderQuotesRequestBasketItemsInner.from_dict(_item) for _item in obj["basketItems"]] if obj.get("basketItems") is not None else None,
            "rates": [CrossBorderQuotesRequestRatesInner.from_dict(_item) for _item in obj["rates"]] if obj.get("rates") is not None else None,
            "shipmentOptions": [CarrierFacilityResponseCarrierFacilityOptionsInner.from_dict(_item) for _item in obj["shipmentOptions"]] if obj.get("shipmentOptions") is not None else None
        })
        return _obj
