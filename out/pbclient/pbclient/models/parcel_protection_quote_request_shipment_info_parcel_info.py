...
class ParcelProtectionQuoteRequestShipmentInfoParcelInfo(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> Self:
        ...
        _obj = cls.model_validate({
            "commodityList": [ParcelProtectionQuoteRequestShipmentInfoParcelInfoCommodityListInner.from_dict(_item) for _item in obj.get("commodityList")] if obj.get("commodityList") is not None else None
        })
        return _obj
