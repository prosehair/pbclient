...
class AddTrackingEventsReferencesInner(BaseModel):
    ...
    events: Optional[List[AddTrackingEventsReferencesInnerEventsInner]] = None
    __properties: ClassVar[List[str]] = ["referenceType", "referenceValue", "events"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "events": [AddTrackingEventsReferencesInnerEventsInner.from_dict(_item) for _item in obj["events"]] if obj.get("events") is not None else None
        })
        return _obj
