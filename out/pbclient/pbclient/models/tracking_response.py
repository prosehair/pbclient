...
class TrackingResponse(BaseModel):
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['Acceptance', 'Delivered', 'DeliveryAttempt', 'Exception', 'InTransit', 'Manifest', 'OutForDelivery', 'PickedUp', 'PickupMissed', 'ReadyForPickup', 'ReturnToSender']):
    ...
    def weight_oum_validate_enum(cls, value):
        ...
        if value not in set(['lb', 'LBS', 'Pounds', 'KGS']):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "destinationAddress": TrackingAddress.from_dict(obj["destinationAddress"]) if obj.get("destinationAddress") is not None else None,
            "senderAddress": TrackingAddress.from_dict(obj["senderAddress"]) if obj.get("senderAddress") is not None else None,
            "currentStatus": EventObject.from_dict(obj["currentStatus"]) if obj.get("currentStatus") is not None else None,
            "scanDetailsList": [EventObject.from_dict(_item) for _item in obj["scanDetailsList"]] if obj.get("scanDetailsList") is not None else None
        })
        return _obj
