...
class CrossBorderQuotesErrorsQuoteInnerQuoteLinesInner(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "unitErrors": [CrossBorderQuotesErrorsQuoteInnerQuoteLinesInnerUnitErrorsInner.from_dict(_item) for _item in obj["unitErrors"]] if obj.get("unitErrors") is not None else None
        })
        return _obj
