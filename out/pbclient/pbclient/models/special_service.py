...
class SpecialService(BaseModel):
    ...
    input_parameters: Optional[List[Parameter]] = Field(default=None, alias="inputParameters")
    ...
    def from_dict(cls, obj: dict) -> Self:
        ...
        _obj = cls.model_validate({
            "fee": obj.get("fee"),
            "inputParameters": [Parameter.from_dict(_item) for _item in obj.get("inputParameters")] if obj.get("inputParameters") is not None else None,
