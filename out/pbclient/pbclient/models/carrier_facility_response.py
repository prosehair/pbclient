...
class CarrierFacilityResponse(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "carrierFacilityOptions": [CarrierFacilityResponseCarrierFacilityOptionsInner.from_dict(_item) for _item in obj.get("carrierFacilityOptions")] if obj.get("carrierFacilityOptions") is not None else None,
            "carrierFacilitySuggestions": [CarrierFacilityResponseCarrierFacilitySuggestionsInner.from_dict(_item) for _item in obj.get("carrierFacilitySuggestions")] if obj.get("carrierFacilitySuggestions") is not None else None
        })
        return _obj
