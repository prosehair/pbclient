...
class SpecialServicesRule(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "inputParameterRules": [ServicesParameterRule.from_dict(_item) for _item in obj["inputParameterRules"]] if obj.get("inputParameterRules") is not None else None,
            "prerequisiteRules": [PrerequisiteRules.from_dict(_item) for _item in obj["prerequisiteRules"]] if obj.get("prerequisiteRules") is not None else None,
