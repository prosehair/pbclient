...
class CrossBorderQuotesResponseQuoteInnerQuoteLinesInnerUnitRatesDeliveryCommitment(BaseModel):
    ...
    """
    min_estimated_number_of_days: Optional[StrictInt] = Field(default=None, alias="minEstimatedNumberOfDays")
    max_estimated_number_of_days: Optional[StrictInt] = Field(default=None, alias="maxEstimatedNumberOfDays")
    __properties: ClassVar[List[str]] = ["minEstimatedNumberOfDays", "maxEstimatedNumberOfDays"]
