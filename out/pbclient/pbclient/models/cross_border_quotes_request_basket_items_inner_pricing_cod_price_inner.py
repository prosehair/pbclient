...
class CrossBorderQuotesRequestBasketItemsInnerPricingCodPriceInner(BaseModel):
    ...
    includes_duty: Optional[StrictBool] = Field(default=None, alias="includesDuty")
    includes_taxes: Optional[StrictBool] = Field(default=None, alias="includesTaxes")
    __properties: ClassVar[List[str]] = ["price", "cod", "includesDuty", "includesTaxes"]
    ...
    def from_dict(cls, obj: dict) -> Self:
        ...
        _obj = cls.model_validate({
            "price": obj.get("price"),
            "cod": obj.get("cod"),
            "includesDuty": obj.get("includesDuty"),
            "includesTaxes": obj.get("includesTaxes")
        })
        return _obj
