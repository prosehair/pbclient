...
class DimensionRules(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "minParcelDimensions": DimensionRulesMinParcelDimensions.from_dict(obj["minParcelDimensions"]) if obj.get("minParcelDimensions") is not None else None,
            "maxParcelDimensions": DimensionRulesMaxParcelDimensions.from_dict(obj["maxParcelDimensions"]) if obj.get("maxParcelDimensions") is not None else None,
