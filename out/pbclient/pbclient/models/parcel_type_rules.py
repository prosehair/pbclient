...
class ParcelTypeRules(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "specialServicesRule": [SpecialServicesRule.from_dict(_item) for _item in obj["specialServicesRule"]] if obj.get("specialServicesRule") is not None else None,
            "weightRules": [WeightRules.from_dict(_item) for _item in obj["weightRules"]] if obj.get("weightRules") is not None else None,
            "dimensionRules": [DimensionRules.from_dict(_item) for _item in obj["dimensionRules"]] if obj.get("dimensionRules") is not None else None,
