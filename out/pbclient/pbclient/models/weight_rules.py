...
class WeightRules(BaseModel):
    ...
    min_weight: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="minWeight")
    max_weight: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="maxWeight")
    __properties: ClassVar[List[str]] = ["required", "unitOfMeasurement", "minWeight", "maxWeight"]
