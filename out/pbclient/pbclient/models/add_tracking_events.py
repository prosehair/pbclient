...
class AddTrackingEvents(BaseModel):
    ...
    references: Optional[List[AddTrackingEventsReferencesInner]] = None
    __properties: ClassVar[List[str]] = ["carrier", "references"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "references": [AddTrackingEventsReferencesInner.from_dict(_item) for _item in obj["references"]] if obj.get("references") is not None else None
        })
        return _obj
