...
class ParcelProtectionQuoteResponse(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "parcelProtectionFeesBreakup": ParcelProtectionQuoteResponseParcelProtectionFeesBreakup.from_dict(obj["parcelProtectionFeesBreakup"]) if obj.get("parcelProtectionFeesBreakup") is not None else None
        })
        return _obj
