...
class Shipment(BaseModel):
    ...
    def shipment_type_validate_enum(cls, value):
        ...
        if value not in set(['OUTBOUND', 'RETURN']):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "additionalAddresses": [AdditionalAddress.from_dict(_item) for _item in obj["additionalAddresses"]] if obj.get("additionalAddresses") is not None else None,
            "altReturnAddress": Address.from_dict(obj["altReturnAddress"]) if obj.get("altReturnAddress") is not None else None,
            "carrierPayments": [CarrierPayment.from_dict(_item) for _item in obj["carrierPayments"]] if obj.get("carrierPayments") is not None else None,
            "customs": Customs.from_dict(obj["customs"]) if obj.get("customs") is not None else None,
            ...
            "hazmatDetails": HazmatDetails.from_dict(obj["hazmatDetails"]) if obj.get("hazmatDetails") is not None else None,
            ...
            "shipmentOptions": [Parameter.from_dict(_item) for _item in obj["shipmentOptions"]] if obj.get("shipmentOptions") is not None else None,
            "shipmentType": obj.get("shipmentType"),
            "soldToAddress": Address.from_dict(obj["soldToAddress"]) if obj.get("soldToAddress") is not None else None,
            "toAddress": Address.from_dict(obj["toAddress"]) if obj.get("toAddress") is not None else None
        })
        return _obj
