...
class CommodityInfo(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "infectiousSubstanceContact": InfectiousSubstanceContact.from_dict(obj["infectiousSubstanceContact"]) if obj.get("infectiousSubstanceContact") is not None else None,
            ...
            "radioActivityDetail": RadioActivityDetail.from_dict(obj["radioActivityDetail"]) if obj.get("radioActivityDetail") is not None else None,
            "radioNuclideDetail": RadioNuclideDetail.from_dict(obj["radioNuclideDetail"]) if obj.get("radioNuclideDetail") is not None else None,
