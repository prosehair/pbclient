...
class ParcelProtectionQuoteRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ParcelProtectionQuoteRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ParcelProtectionQuoteRequest:
        """Create an instance of ParcelProtectionQuoteRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ParcelProtectionQuoteRequest.parse_obj(obj)

        _obj = ParcelProtectionQuoteRequest.parse_obj({
            ...
            "shipment_info": ParcelProtectionQuoteRequestShipmentInfo.from_dict(obj.get("shipmentInfo")) if obj.get("shipmentInfo") is not None else None
        })
        return _obj
