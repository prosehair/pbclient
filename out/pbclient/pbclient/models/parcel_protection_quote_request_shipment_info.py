...
class ParcelProtectionQuoteRequestShipmentInfo(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "parcelInfo": ParcelProtectionQuoteRequestShipmentInfoParcelInfo.from_dict(obj["parcelInfo"]) if obj.get("parcelInfo") is not None else None,
            "shipperInfo": ParcelProtectionQuoteRequestShipmentInfoShipperInfo.from_dict(obj["shipperInfo"]) if obj.get("shipperInfo") is not None else None,
            "consigneeInfo": ParcelProtectionQuoteRequestShipmentInfoConsigneeInfo.from_dict(obj["consigneeInfo"]) if obj.get("consigneeInfo") is not None else None
        })
        return _obj
