...
class CrossBorderQuotesResponseQuoteInnerQuoteLinesInnerLineRates(BaseModel):
    ...
    """
    line_price: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="linePrice")
    ...
    __properties: ClassVar[List[str]] = ["linePrice", "totalTaxAmount", "totalDutyAmount", "serviceId", "baseCharge", "deliveryCommitment", "totalCarrierCharge"]
