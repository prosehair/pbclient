...
class CrossBorderQuotesRequestBasketItemsInnerCategoriesInnerDescriptionsInner(BaseModel):
    ...
    parents_names: Optional[List[StrictStr]] = Field(default=None, alias="parentsNames")
    __properties: ClassVar[List[str]] = ["locale", "name", "parentsNames"]
    ...
    def from_dict(cls, obj: dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "parentsNames": obj.get("parentsNames")
        })
        return _obj
