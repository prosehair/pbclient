...
class CrossBorderQuotesRequestBasketItemsInner(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "unitWeight": CrossBorderQuotesRequestBasketItemsInnerUnitWeight.from_dict(obj.get("unitWeight")) if obj.get("unitWeight") is not None else None,
            "itemDimension": CrossBorderQuotesRequestBasketItemsInnerItemDimension.from_dict(obj.get("itemDimension")) if obj.get("itemDimension") is not None else None,
            "url": obj.get("url"),
