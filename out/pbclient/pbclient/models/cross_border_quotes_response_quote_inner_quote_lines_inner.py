...
class CrossBorderQuotesResponseQuoteInnerQuoteLinesInner(BaseModel):
    ...
    quote_line_id: Optional[StrictStr] = Field(default=None, alias="quoteLineId")
    quantity: Optional[StrictInt] = None
    unit_rates: Optional[CrossBorderQuotesResponseQuoteInnerQuoteLinesInnerUnitRates] = Field(default=None, alias="unitRates")
    line_rates: Optional[CrossBorderQuotesResponseQuoteInnerQuoteLinesInnerLineRates] = Field(default=None, alias="lineRates")
    __properties: ClassVar[List[str]] = ["lineId", "itemId", "quoteLineId", "quantity", "unitRates", "lineRates"]
    ...
    def from_dict(cls, obj: dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "quoteLineId": obj.get("quoteLineId"),
            "quantity": obj.get("quantity"),
            "unitRates": CrossBorderQuotesResponseQuoteInnerQuoteLinesInnerUnitRates.from_dict(obj.get("unitRates")) if obj.get("unitRates") is not None else None,
            "lineRates": CrossBorderQuotesResponseQuoteInnerQuoteLinesInnerLineRates.from_dict(obj.get("lineRates")) if obj.get("lineRates") is not None else None
        })
        return _obj
