...
class CrossBorderQuotesResponseQuoteInnerQuoteLinesInner(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "unitRates": CrossBorderQuotesResponseQuoteInnerQuoteLinesInnerUnitRates.from_dict(obj["unitRates"]) if obj.get("unitRates") is not None else None,
            "lineRates": CrossBorderQuotesResponseQuoteInnerQuoteLinesInnerLineRates.from_dict(obj["lineRates"]) if obj.get("lineRates") is not None else None
        })
        return _obj
