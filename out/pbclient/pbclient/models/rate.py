...
class Rate(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "baseChargeTaxes": [Tax.from_dict(_item) for _item in obj["baseChargeTaxes"]] if obj.get("baseChargeTaxes") is not None else None,
            "carrier": obj.get("carrier"),
            "currencyCode": obj.get("currencyCode"),
            "deliveryCommitment": DeliveryCommitment.from_dict(obj["deliveryCommitment"]) if obj.get("deliveryCommitment") is not None else None,
            "destinationZone": RateDestinationZone.from_dict(obj["destinationZone"]) if obj.get("destinationZone") is not None else None,
            "dimensionalWeight": ParcelWeight.from_dict(obj["dimensionalWeight"]) if obj.get("dimensionalWeight") is not None else None,
            ...
            "surcharges": [Surcharge.from_dict(_item) for _item in obj["surcharges"]] if obj.get("surcharges") is not None else None,
