...
class ParcelProtectionPolicyResponseContentInnerShipperInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["shipperID", "firstName", "middleName", "lastName", "company", "email", "phoneNumber1", "phoneNumber2", "faxNumber", "address"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "address": ParcelProtectionPolicyResponseContentInnerShipperInfoAddress.from_dict(obj["address"]) if obj.get("address") is not None else None
        })
        return _obj
