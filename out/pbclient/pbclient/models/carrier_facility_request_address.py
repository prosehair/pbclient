...
class CarrierFacilityRequestAddress(BaseModel):
    """
    ...
    __properties = ["addressLines", "cityTown", "stateProvince", "countryCode"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CarrierFacilityRequestAddress:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CarrierFacilityRequestAddress:
        """Create an instance of CarrierFacilityRequestAddress from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CarrierFacilityRequestAddress.parse_obj(obj)

        _obj = CarrierFacilityRequestAddress.parse_obj({
