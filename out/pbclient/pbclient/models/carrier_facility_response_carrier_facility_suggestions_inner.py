...
class CarrierFacilityResponseCarrierFacilitySuggestionsInner(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "carrierFacilityAttributes": [CarrierFacilityResponseCarrierFacilityOptionsInner.from_dict(_item) for _item in obj["carrierFacilityAttributes"]] if obj.get("carrierFacilityAttributes") is not None else None,
            "facilityHours": [CarrierFacilityResponseCarrierFacilitySuggestionsInnerFacilityHoursInner.from_dict(_item) for _item in obj["facilityHours"]] if obj.get("facilityHours") is not None else None,
