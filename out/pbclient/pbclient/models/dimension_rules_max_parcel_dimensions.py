...
class DimensionRulesMaxParcelDimensions(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DimensionRulesMaxParcelDimensions:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DimensionRulesMaxParcelDimensions:
        """Create an instance of DimensionRulesMaxParcelDimensions from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DimensionRulesMaxParcelDimensions.parse_obj(obj)

        _obj = DimensionRulesMaxParcelDimensions.parse_obj({
