...
class ParcelDimension(BaseModel):
    ...
    unit_of_measurement: Optional[UnitOfDimension] = Field(default=None, alias="unitOfMeasurement")
    irregular_parcel_girth: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="irregularParcelGirth")
    __properties: ClassVar[List[str]] = ["length", "height", "width", "unitOfMeasurement", "irregularParcelGirth"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "irregularParcelGirth": obj.get("irregularParcelGirth")
        })
        return _obj
